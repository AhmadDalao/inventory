...
// Extracted settings schema definitions. Function name is preserved for compatibility.
...
function site_setting_schema(): array
{
    ...
    $schema = [
        ...
        [
            'id' => 'mobile-access',
            'title' => 'Mobile Access',
            'copy' => 'Control the Flutter app without changing server files.',
            'fields' => [
                'mobile.enabled' => [
                    ...
                    'help' => 'Keep disabled until the internal Android pilot begins.',
                    'maxlength' => 1,
                ],
                'mobile.manual_restock_enabled' => [
                    'label' => 'Allow privileged direct restock',
                    'default' => '0',
                    'type' => 'select',
                    'options' => ['0' => 'Disabled', '1' => 'Enabled'],
                    'help' => 'The employee must also have movements.restock permission.',
                    'maxlength' => 1,
                ],
                'mobile.offline_drafts_enabled' => [
                    'label' => 'Allow offline drafts',
                    'default' => '1',
                    'type' => 'select',
                    'options' => ['0' => 'Disabled', '1' => 'Enabled'],
                    'help' => 'Drafts synchronize later; stock never posts offline.',
                    'maxlength' => 1,
                ],
                'mobile.require_usage_proof' => [
                    'label' => 'Require usage proof image',
                    'default' => '0',
                    'type' => 'select',
                    'options' => ['0' => 'No', '1' => 'Yes'],
                    'maxlength' => 1,
                ...
                'mobile.min_supported_version' => [
                    ...
                    'default' => '1.0.0',
                    'help' => 'Older applications receive an upgrade-required response.',
                    'maxlength' => 40,
                ],
            ],
        ],
