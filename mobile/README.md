...
- File: `../output/mobile/inventory-kona-1.3.6+13.apk`
- Package: `com.konajeddah.inventory`
- Version: `1.3.6` (`versionCode 13`)
- Minimum Android: API 24
- SHA-256: recorded in `../output/mobile/inventory-kona-1.3.6+13.apk.sha256` after the signed build.
- Checksum file: `../output/mobile/inventory-kona-1.3.6+13.apk.sha256`
- Release evidence: `../docs/mobile/release-1.3.6.md`

Verify it before distribution:

```bash
shasum -a 256 ../output/mobile/inventory-kona-1.3.6+13.apk
$ANDROID_HOME/build-tools/36.0.0/apksigner verify --verbose --print-certs \
  ../output/mobile/inventory-kona-1.3.6+13.apk
```
